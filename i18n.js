...
(function () {
  ...
  const I18N = {
    en: {
      ...
      'dl.h1': 'PollSlide Companion<br>for Mac', 'dl.lead': 'Live poll results that float over any presentation — Keynote, PowerPoint, Google Slides or a PDF — and appear automatically when your QR is on screen.', 'dl.status': 'Awaiting Apple App Store review', 'dl.h2steps': 'Up and running in three steps', 'dl.h2feat': "What's in the app", 'dl.h2sys': 'System requirements',
    ...
    es: {
      ...
      'dl.h1': 'PollSlide Companion<br>para Mac', 'dl.lead': 'Resultados de encuestas en vivo que flotan sobre cualquier presentación — Keynote, PowerPoint, Google Slides o un PDF — y aparecen automáticamente cuando tu QR está en pantalla.', 'dl.status': 'En revisión por la App Store de Apple', 'dl.h2steps': 'Listo en tres pasos', 'dl.h2feat': 'Qué incluye la app', 'dl.h2sys': 'Requisitos del sistema',
    ...
    de: {
      ...
      'dl.h1': 'PollSlide Companion<br>für Mac', 'dl.lead': 'Live-Umfrageergebnisse, die über jeder Präsentation schweben — Keynote, PowerPoint, Google Slides oder einem PDF — und automatisch erscheinen, sobald dein QR-Code auf dem Bildschirm ist.', 'dl.status': 'In Prüfung durch den Apple App Store', 'dl.h2steps': 'In drei Schritten startklar', 'dl.h2feat': 'Was die App kann', 'dl.h2sys': 'Systemvoraussetzungen',
    ...
    fr: {
      ...
      'dl.h1': 'PollSlide Companion<br>pour Mac', 'dl.lead': 'Des résultats de sondage en direct qui flottent au-dessus de n\'importe quelle présentation — Keynote, PowerPoint, Google Slides ou un PDF — et apparaissent automatiquement dès que votre QR est à l\'écran.', 'dl.status': 'En cours d\'examen par l\'App Store d\'Apple', 'dl.h2steps': 'Opérationnel en trois étapes', 'dl.h2feat': 'Ce que contient l\'app', 'dl.h2sys': 'Configuration requise',
    ...
    pt: {
      ...
      'dl.h1': 'PollSlide Companion<br>para Mac', 'dl.lead': 'Resultados de enquetes ao vivo que flutuam sobre qualquer apresentação — Keynote, PowerPoint, Google Slides ou um PDF — e aparecem automaticamente quando seu QR está na tela.', 'dl.status': 'Em análise pela App Store da Apple', 'dl.h2steps': 'Pronto em três passos', 'dl.h2feat': 'O que tem no app', 'dl.h2sys': 'Requisitos do sistema',
    ...
    it: {
      ...
      'dl.h1': 'PollSlide Companion<br>per Mac', 'dl.lead': 'Risultati dei sondaggi in tempo reale che fluttuano sopra qualsiasi presentazione — Keynote, PowerPoint, Google Slides o un PDF — e appaiono automaticamente quando il tuo QR è sullo schermo.', 'dl.status': 'In revisione sull\'App Store di Apple', 'dl.h2steps': 'Pronto in tre passi', 'dl.h2feat': 'Cosa c\'è nell\'app', 'dl.h2sys': 'Requisiti di sistema',
