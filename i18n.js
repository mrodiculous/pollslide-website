...
(function () {
  ...
  const I18N = {
    en: {
      ...
      'int.h1': 'PollSlide in <span class="accent">your slides</span>', 'int.lead': 'Keynote works today via the Mac companion. The PowerPoint add-in is built and <strong>in review with Microsoft</strong> — here\'s the status, how to set each one up, and a walkthrough video.', 'int.mac': 'Mac Companion (Keynote)', 'int.macSub': "A floating window that shows live results over your Keynote slides and auto-detects your poll's QR.", 'int.macStatus': 'Awaiting Apple App Store review', 'int.ppt': 'PowerPoint Add-in', 'int.pptSub': 'Works in PowerPoint on Windows, Mac and the web — insert live polls and results right onto your slides.', 'int.pptStatus': 'Awaiting Microsoft AppSource approval', 'int.howto': 'How to set it up', 'int.video': 'Walkthrough video — coming soon', 'int.ctah': "Don't want to wait?",
    },
    es: {
